...
class HateSpeechDetector:
    ...
    def __init__(self, tipoVectorizacion, nombreModelo, tipoNormalizacion = "Completo"):
        ...
        self.archivoNormalizacion = {
            "Completo": "./Data/normalizado/HateSpeech_Completo.csv",
            "Tokenizacion": "./Data/normalizado/HateSpeech_Tokenizacion.csv",
            "Stopwords": "./Data/normalizado/HateSpeech_Stopwords.csv",
            "Lematizacion": "./Data/normalizado/HateSpeech_Lematizacion.csv",
            "Tokenizacion_Stopwords": "./Data/normalizado/HateSpeech_Tokenizacion_Stopwords.csv",
            "Tokenizacion_Lematizacion": "./Data/normalizado/HateSpeech_Tokenizacion_Lematizacion.csv",
            "Stopwords_Lematizacion": "./Data/normalizado/HateSpeech_Lematizado_Stopwords.csv"
        }
...
def ejecutar_todos_tipos(modo="completo"):
    ...
    detector_temp = HateSpeechDetector(tipoVectorizacion="tfidf", nombreModelo="naive_bayes")
